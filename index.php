...
<div class="modal" id="loginModal">
    <div class="modal-content">
        ...
        <form id="loginForm" action="login.php" method="POST">
            ...
            <div class="error-message" id="loginError" style="color:red; margin-bottom:10px;">
    <?php if(!empty($login_error)) echo htmlspecialchars($login_error); ?>
</div>
...
<a href="admin.php" id="adminLoginBtn">Admin Login</a>
